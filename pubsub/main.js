var clientId = "yi732pppgs5yyau0pv4pcwlmrty9f6"
var redirectURI = "http://localhost:5000/"
var scope = ["channel_read", "channel:moderate", "chat:read"].join("+")
var ws
...
$(function() {
  ...
  if (sessionStorage.twitchOAuthToken) {
    ...
    $.ajax({
      ...
      $("#topic-label").text(
        "Enter a topic to listen to. For example, to listen to whispers enter topic 'whispers." +
          user._id +
          "'"
      )
    })
